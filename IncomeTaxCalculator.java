public class IncomeTaxCalculator {
    ...
    private static final long JANUARY_01_1948 = -694310400;
    private static final long DECEMBER_01_1948 = -665366400;
    private static final long NOVEMBER_01_1949 = -636422400;
    private static final long OCTOBER_01_1950 = -607564800;
    private static final long July_01_1951 = -583977600;
    ...
    boolean isAowEligible(long birthday) {
        return birthday < JANUARY_01_1948
            || (birthday > JANUARY_01_1948 && birthday < DECEMBER_01_1948)
            || (birthday > DECEMBER_01_1948 && birthday < NOVEMBER_01_1949)
            || (birthday > NOVEMBER_01_1949 && birthday < OCTOBER_01_1950)
            || (birthday > OCTOBER_01_1950 && birthday < July_01_1951);
    }

    private double getTaxrate(int disc, boolean aowEligible) {
        if (disc == 1 && aowEligible) {
            return TAXRATE_18PRECENT;
        }
        if (disc == 1) {
            return TAXRATE_36PRECENT;
        }

        if (disc == 2 && aowEligible) {
            return TAXRATE_22PRECENT;
        }
        if (disc == 2) {
            return TAXRATE_40PRECENT;
        }
